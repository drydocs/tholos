...
export const Errors = {
   ...
   */
  23: {message:"InvalidStalledDisputeTimeout"},
  /**
   * `reclaim_stalled_dispute` was called before the dispute timeout elapsed.
   */
  24: {message:"DisputeTimeoutNotElapsed"}
}

export type Status = {tag: "Pending", values: void} | {tag: "Disputed", values: void} | {tag: "Resolved", values: void};

export type DataKey = {tag: "Admin", values: void} | {tag: "Token", values: void} | {tag: "BondAmount", values: void} | {tag: "ChallengeWindow", values: void} | {tag: "Resolvers", values: void} | {tag: "Assertion", values: readonly [u64]} | {tag: "NextId", values: void} | {tag: "Paused", values: void} | {tag: "FinalizeRewardBps", values: void} | {tag: "RotationProposal", values: void} | {tag: "StalledDisputeTimeout", values: void};
...
export interface Client {
   ...
   */
  initialize: ({admin, token, bond_amount, challenge_window_secs, resolvers, finalize_reward_bps, stalled_dispute_timeout_secs}: {admin: string, token: string, bond_amount: i128, challenge_window_secs: u64, resolvers: Array<string>, finalize_reward_bps: u32, stalled_dispute_timeout_secs: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  reclaim_stalled_dispute: ({id}: {id: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>

  /**
   * Construct and simulate a get_stalled_dispute_timeout transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Returns the currently configured stalled dispute timeout duration in seconds.
   */
  get_stalled_dispute_timeout: (options?: MethodOptions) => Promise<AssembledTransaction<Result<u64>>>

  /**
   * Construct and simulate a set_stalled_dispute_timeout transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Updates the stalled dispute timeout duration. Only callable by the
   * admin set at initialization.
   */
  set_stalled_dispute_timeout: ({stalled_dispute_timeout_secs}: {stalled_dispute_timeout_secs: u64}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "AAAAAgAAAAAAAAAAAAAABlN0YXR1cwAAAAAAAwAAAAAAAAAAAAAAB1BlbmRpbmcAAAAAAAAAAAAAAAAIRGlzcHV0ZWQAAAAAAAAAAAAAAAhSZXNvbHZlZA==",
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        "AAAABQAAAAAAAAAAAAAAF1N0YWxsZWREaXNwdXRlUmVjbGFpbWVkAAAAAAEAAAAZc3RhbGxlZF9kaXNwdXRlX3JlY2xhaW1lZAAAAAAAAAQAAAAAAAAAAmlkAAAAAAAGAAAAAQAAAAAAAAAIYXNzZXJ0ZXIAAAATAAAAAAAAAAAAAAAIZGlzcHV0ZXIAAAATAAAAAAAAAAAAAAAEYm9uZAAAAAsAAAAAAAAAAg==",
        "AAAAAAAAAE1SZXR1cm5zIHRoZSBjdXJyZW50bHkgY29uZmlndXJlZCBzdGFsbGVkIGRpc3B1dGUgdGltZW91dCBkdXJhdGlvbiBpbiBzZWNvbmRzLgAAAAAAABtnZXRfc3RhbGxlZF9kaXNwdXRlX3RpbWVvdXQAAAAAAAAAAAEAAAPpAAAABgAAAAM=",
        "",
        "AAAABQAAAAAAAAAAAAAAHFN0YWxsZWREaXNwdXRlVGltZW91dFVwZGF0ZWQAAAABAAAAH3N0YWxsZWRfZGlzcHV0ZV90aW1lb3V0X3VwZGF0ZWQAAAAAAQAAAAAAAAAcc3RhbGxlZF9kaXNwdXRlX3RpbWVvdXRfc2VjcwAAAAYAAAAAAAAAAg==" ]),
      options
    )
  }
  public readonly fromJSON = {
    dispute: this.txFromJSON<Result<void>>,
        ...
        get_stalled_dispute_timeout: this.txFromJSON<Result<u64>>,
        set_stalled_dispute_timeout: this.txFromJSON<Result<void>>
  }
}