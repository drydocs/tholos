...
- [x] Bond sizing validated against modeled spam/griefing attempts; see [BOND_SIZING.md](BOND_SIZING.md) and [V1_BOND_SIZING.md](V1_BOND_SIZING.md) for concrete mainnet parameter recommendations
